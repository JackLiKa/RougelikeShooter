...
namespace CharacterPanelScene
{
    public class CharacterPanelRoot : IPanel
    {
        ...
        public void DrawGUI()
        {
            ...
            DrawStatsCard(new Rect(580f, 154f, 472f, 784f), profile);
        ...
        {
            DrawCompatibleLabel(new Rect(VirtualWidth * 0.5f - 280f, 44f, 560f, 34f), "\u89d2\u8272\u9762\u677f", CreateLabelStyle(30, FontStyle.Bold, TextAnchor.MiddleCenter, Color.white));
            DrawCompatibleLabel(new Rect(VirtualWidth * 0.5f - 420f, 84f, 840f, 22f), $"{profile.DisplayName}  |  \u5f53\u524d\u6b66\u5668\uff1a{GameSelectionConfig.GetWeaponDisplayName(GameSelectionConfig.CurrentWeaponType)}  |  \u91d1\u5e01\uff1a{progress.Coins}", CreateLabelStyle(16, FontStyle.Normal, TextAnchor.MiddleCenter, SoftText));
        }

        private void DrawHeroCard(Rect rect, PlayerType playerType, PlayerProfile profile)
        {
            DrawCard(rect, "\u89d2\u8272\u9884\u89c8");
            DrawCompatibleLabel(new Rect(rect.x + 24f, rect.y + 46f, rect.width - 48f, 28f), profile.DisplayName, CreateLabelStyle(24, FontStyle.Bold, TextAnchor.UpperLeft, Color.white));
            DrawCompatibleLabel(new Rect(rect.x + 24f, rect.y + 80f, rect.width - 48f, 18f), GameSelectionConfig.GetPlayerDisplayName(playerType), CreateLabelStyle(14, FontStyle.Normal, TextAnchor.UpperLeft, SoftText));
        ...
        private void DrawStatsCard(Rect rect, PlayerProfile profile)
        {
            ...
            DrawStatRow(rect.x + 28f, rect.y + 492f, rect.width - 56f, "\u89d2\u8272\u5f3a\u5316\u7b49\u7ea7", $"{UserProgressRepository.GetUpgradeLevel(GameSelectionConfig.CurrentPlayerType)}/{UserProgressRepository.GetPlayerUpgradeCap()}", labelStyle, valueStyle);
            DrawStatRow(rect.x + 28f, rect.y + 576f, rect.width - 56f, "\u4e0b\u6b21\u5f3a\u5316\u82b1\u8d39", UserProgressRepository.IsPlayerUpgradeAtCap(GameSelectionConfig.CurrentPlayerType) ? "\u5df2\u6ee1\u7ea7" : UserProgressRepository.GetNextUpgradeCost(GameSelectionConfig.CurrentPlayerType).ToString(), labelStyle, valueStyle);

            if (DrawButton(new Rect(rect.x + 28f, rect.y + rect.height - 142f, rect.width - 56f, 46f), "\u5f3a\u5316\u5f53\u524d\u89d2\u8272"))
            {
                if (UserProgressRepository.IsPlayerUpgradeAtCap(GameSelectionConfig.CurrentPlayerType))
                {
                    statusMessage = $"\u5f53\u524d User \u7b49\u7ea7\u6700\u591a\u53ea\u80fd\u628a Player \u5347\u5230 {UserProgressRepository.GetPlayerUpgradeCap()} \u7ea7\u3002";
                }
                else if (UserProgressRepository.TryUpgradePlayer(GameSelectionConfig.CurrentPlayerType))
                {
                    GameVoiceManager.PlayUpgradePlayer();
        ...
        private void DrawProgressCard(Rect rect, PlayerProfile profile, UserProgressData progress)
        {
            ...
            DrawCompatibleLabel(new Rect(rect.x + 28f, rect.y + 56f, rect.width - 56f, 28f), "\u5f53\u524d\u9009\u62e9", CreateLabelStyle(24, FontStyle.Bold, TextAnchor.UpperLeft, TitleColor));
            DrawCompatibleLabel(new Rect(rect.x + 28f, rect.y + 96f, rect.width - 56f, 22f), $"\u89d2\u8272\uff1a{profile.DisplayName}", CreateLabelStyle(18, FontStyle.Bold, TextAnchor.UpperLeft, Color.white));
            DrawCompatibleLabel(new Rect(rect.x + 28f, rect.y + 126f, rect.width - 56f, 22f), $"\u6b66\u5668\uff1a{GameSelectionConfig.GetWeaponDisplayName(GameSelectionConfig.CurrentWeaponType)}", CreateLabelStyle(18, FontStyle.Bold, TextAnchor.UpperLeft, Color.white));
            ...
            DrawCompatibleLabel(new Rect(infoRect.x + 18f, infoRect.y + 18f, infoRect.width - 36f, 24f), "\u5c40\u5916\u6210\u957f\u6570\u636e", CreateLabelStyle(18, FontStyle.Bold, TextAnchor.UpperLeft, Accent));
            DrawCompatibleLabel(new Rect(infoRect.x + 18f, infoRect.y + 56f, infoRect.width - 36f, 22f), $"\u7528\u6237\u7b49\u7ea7\uff1a{progress.Level}", CreateLabelStyle(18, FontStyle.Bold, TextAnchor.UpperLeft, Color.white));
            DrawCompatibleLabel(new Rect(infoRect.x + 18f, infoRect.y + 88f, infoRect.width - 36f, 22f), $"\u91d1\u5e01\uff1a{progress.Coins}", CreateLabelStyle(18, FontStyle.Bold, TextAnchor.UpperLeft, Color.white));
            DrawCompatibleLabel(new Rect(infoRect.x + 18f, infoRect.y + 120f, infoRect.width - 36f, 22f), $"\u7ecf\u9a8c\uff1a{progress.CurrentExp}/{UserProgressRepository.GetRequiredExpForLevel(progress.Level)}", CreateLabelStyle(16, FontStyle.Normal, TextAnchor.UpperLeft, SoftText));
            DrawCompatibleLabel(new Rect(infoRect.x + 18f, infoRect.y + 156f, infoRect.width - 36f, 72f), "\u5f00\u59cb\u6e38\u620f\u540e\uff0c\u51fb\u6740\u602a\u7269\u4f1a\u83b7\u5f97\u7ecf\u9a8c\uff0c\u63d0\u5347\u6ce2\u6b21\u8868\u73b0\u53ef\u83b7\u5f97\u91d1\u5e01\u4e0e\u7528\u6237\u7ecf\u9a8c\uff0c\u7528\u4e8e\u5c40\u5916\u6301\u7eed\u63d0\u5347 Player \u5c5e\u6027\u3002", CreateLabelStyle(16, FontStyle.Normal, TextAnchor.UpperLeft, SoftText));

            if (!string.IsNullOrWhiteSpace(statusMessage) && Time.realtimeSinceStartup <= statusMessageUntil)
            {
                DrawCompatibleLabel(new Rect(rect.x + 28f, rect.y + 452f, rect.width - 56f, 24f), statusMessage, CreateLabelStyle(16, FontStyle.Bold, TextAnchor.UpperLeft, Accent));
            }
            ...
            DrawCompatibleLabel(new Rect(actionRect.x + 18f, actionRect.y + 18f, actionRect.width - 36f, 22f), "\u64cd\u4f5c", CreateLabelStyle(18, FontStyle.Bold, TextAnchor.UpperLeft, Accent));
        ...
        private void DrawReturnDialog()
        {
            ...
            DrawCompatibleLabel(new Rect(dialogRect.x + 24f, dialogRect.y + 62f, dialogRect.width - 48f, 24f), "\u8fd4\u56de\u4e3b\u83dc\u5355\u5417\uff1f", CreateLabelStyle(20, FontStyle.Bold, TextAnchor.MiddleCenter, Color.white));
            DrawCompatibleLabel(new Rect(dialogRect.x + 24f, dialogRect.y + 92f, dialogRect.width - 48f, 20f), "\u5f53\u524d\u89d2\u8272\u4e0e\u6b66\u5668\u9009\u62e9\u4f1a\u88ab\u4fdd\u7559\u3002", CreateLabelStyle(14, FontStyle.Normal, TextAnchor.MiddleCenter, SoftText));
        ...
        private void DrawCard(Rect rect, string title)
        {
            ...
            DrawCompatibleLabel(new Rect(rect.x + 20f, rect.y + 14f, rect.width - 40f, 22f), title, CreateLabelStyle(18, FontStyle.Bold, TextAnchor.UpperLeft, TitleColor));
        }

        private void DrawStatRow(float x, float y, float width, string label, string value, GUIStyle labelStyle, GUIStyle valueStyle)
        {
            DrawCompatibleLabel(new Rect(x, y, width, 24f), label, labelStyle);
            DrawCompatibleLabel(new Rect(x, y + 28f, width, 32f), value, valueStyle);
        }
